...
int main() {
    ...
    char letter = 'h'; // use single quotes to represent a character
    bool is_valid = false;
    ...
    int number_2 {0}; // brace initalization is 0 without anything
    cout << number_2;
    int number_3; 
    cout << number_3; // gives us a random value everytime we run our program if it is not initialized to zero directly or brace initialization
    return 0;
}